...
if(empty($_SESSION['lang'])) {
    $lang = 'en';
    $data = include $_SERVER['DOCUMENT_ROOT'].'/config.php';
    $langs = $data['langs'];
    if (($_SERVER['HTTP_REFERER']) != '/') {
        $url = explode('?', trim(str_replace('http://','',str_replace('https://','',$_SERVER['HTTP_REFERER'])), '/'));
        $url = explode('/', $url[0]);
        $u = $url[1];
        if(in_array(strtoupper($u),$langs) && strtolower($u) != 'en') {
            $lang = strtolower($u);
        }
    }
...
$config = array(
    ...
    */
    ...
    |
    */
    'upload_dir' => '/public/src/img/'.$lang.'/upload/',
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    'current_path' => '../../../../public/src/img/'.$lang.'/upload/',
    ...
    |
    */
    'thumbs_base_path' => '../../../../public/src/img/'.$lang.'/upload_thumb/',
    ...
    |
    */
    'thumbs_upload_dir' => '/public/src/img/'.$lang.'/upload_thumb/',
    ...
    */
    ...
    |---------------------------------------------------------------------------
    */
    'ftp_thumbs_dir' => '/public/src/img/'.$lang.'/upload_thumb/',
    'ftp_ssl' => false,
    'ftp_port' => 21,
