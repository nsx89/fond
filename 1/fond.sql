...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 14 2025 г., 23:49
...
INSERT INTO `pages` (`id`, `name`, `url`, `parent`, `show`, `menu`, `menu_footer`, `rate`, `rate_footer`, `image`, `file`, `text`) VALUES
(1, 'Главная', '/', -1, 1, 0, 0, 0, NULL, NULL, NULL, ''),
(3, 'О проекте', 'o-proekte', 0, 1, 1, 1, 0, 90, NULL, NULL, ''),
(4, 'Оказать помощь', 'okazat-pomosch', 0, 1, 1, 1, 0, 70, NULL, NULL, ''),
(5, 'Документы', 'dokumenty', 0, 1, 1, 1, 0, 50, NULL, NULL, ''),
(6, 'Статьи', 'stat-i', 0, 1, 1, 1, 0, 80, NULL, NULL, ''),
(7, 'Волонтеры', 'volontery', 0, 1, 1, 1, 0, 40, NULL, NULL, ''),
(8, 'Партнеры', 'partnery', 0, 1, 1, 1, 0, 30, NULL, NULL, ''),
(9, 'Контакты', 'kontakty', 0, 1, 1, 1, 0, 60, NULL, NULL, '');
...
INSERT INTO `settings` (`id`, `title`, `email`, `email_send`, `phone`, `phone2`, `address`, `logo`, `soc1`, `soc2`, `soc_name1`, `soc_name2`, `copy`, `copy2`) VALUES
(1, 'Фонд поддержки ветеранов боевых действий', 'veec@bk.ru', 'veec@bk.ru', '+7 (911) 136 80 05', NULL, NULL, NULL, 'https://t.me/volonterspb777', 'https://vk.com/club227952307', '@volonterspb777', 'Фонд «Северный Легион»', 'ООО Фонд поддержки ветеранов боевых действий,', 'Все права защищены.');
...
(1, 'test@test.ru', '$2y$10$XtyDvJE9Hj35l9r2uSDhWOQVg9Ad5HVNa27gTrizl2KSwBM/EiKlq', '1a2d7230e9de1a3de34464cc1bcf12d7', NULL, 1, 1748093726, 1757882927, 'Тест Тестов', '+7 (111) 111-11-39');
